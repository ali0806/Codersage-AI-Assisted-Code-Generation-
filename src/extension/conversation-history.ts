...
import { codersageProvider } from './provider-manager'
...
export class ConversationHistory {
  ...
  private _config = workspace.getConfiguration('codersage')
  ...
  private getProvider = () => {
    return this._context?.globalState.get<codersageProvider>(
      ACTIVE_CHAT_PROVIDER_STORAGE_KEY
    )
  }
